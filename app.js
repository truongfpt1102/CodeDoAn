...
// Event Listener When Click Will Be Move List Of Songs and Author
...
Array.from(document.getElementsByClassName('artists')).forEach((e, i) => {
    e.getElementsByTagName('img')[0].src = songs[i].poster;
})
...
// Get Id to listen song what you want
let index = 0;
